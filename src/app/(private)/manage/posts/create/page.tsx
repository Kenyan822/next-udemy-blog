    ...
    <div className="container mx-auto mt-10">
      ...
      <form action={formAction} className="space-y-4">
        ...
        <div>
            ...
            <TextareaAutosize 
            id="content" name="content" className="w-full border p-2" placeholder="マークダウン形式で入力してください" minRows={8} value={content} onChange={handleContentChange}/>
        ...
        <div>
          ...
          {preview && (
            <div className="border p-4 bg-gray-50 prose max-w-none">
              ...
              skipHtml={false}
              unwrapDisallowed={true}>{content}</ReactMarkdown>
            </div>
          )}
